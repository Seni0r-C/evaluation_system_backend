...
-- Volcando datos para la tabla gestion_titulacion.rubrica_criterio: ~28 rows (aproximadamente)
...
-- Volcando datos para la tabla gestion_titulacion.rubrica_evaluacion: ~41 rows (aproximadamente)
INSERT INTO `rubrica_evaluacion` (`id`, `trabajo_id`, `rubrica_id`, `rubrica_criterio_id`, `docente_id`, `estudiante_id`, `puntaje_obtenido`) VALUES
	(1, 3, 9, 44, 27, 63, 20.00),
	(2, 3, 9, 45, 27, 63, 10.00),
	(3, 3, 9, 46, 27, 63, 10.00),
	(4, 3, 9, 47, 27, 63, 4.00),
	(5, 3, 9, 48, 27, 63, 10.00),
	(6, 3, 9, 49, 27, 63, 3.00),
	(7, 3, 8, 50, 27, 63, 30.00),
	(8, 3, 8, 51, 27, 63, 3.00),
	(9, 3, 8, 52, 27, 63, 3.00),
	(10, 3, 8, 53, 27, 63, 10.00),
	(11, 3, 8, 54, 27, 63, 2.00),
	(12, 3, 9, 44, 8, 63, 20.00),
	(13, 3, 9, 45, 8, 63, 10.00),
	(14, 3, 9, 46, 8, 63, 2.00),
	(15, 3, 9, 47, 8, 63, 7.00),
	(16, 3, 9, 48, 8, 63, 9.00),
	(17, 3, 9, 49, 8, 63, 20.00),
	(18, 3, 8, 50, 8, 63, 7.00),
	(19, 3, 8, 51, 8, 63, 20.00),
	(20, 3, 8, 52, 8, 63, 10.00),
	(21, 3, 8, 53, 8, 63, 9.00),
	(22, 3, 8, 54, 8, 63, 22.00),
	(23, 3, 9, 44, 44, 63, 33.00),
	(24, 3, 9, 45, 44, 63, 10.00),
	(25, 3, 9, 46, 44, 63, 8.00),
	(26, 3, 9, 47, 44, 63, 9.00),
	(27, 3, 9, 48, 44, 63, 9.00),
	(28, 3, 9, 49, 44, 63, 8.00),
	(29, 3, 8, 50, 44, 63, 5.00),
	(30, 3, 8, 51, 44, 63, 4.00),
	(31, 3, 8, 52, 44, 63, 5.00),
	(32, 3, 8, 53, 44, 63, 5.00),
	(33, 3, 8, 54, 44, 63, 8.00),
	(34, 3, 7, 21, 27, 63, 40.00),
	(35, 3, 7, 21, 8, 63, 40.00),
	(36, 3, 7, 21, 44, 63, 40.00),
	(114, 2, 3, 39, 27, 47, 30.00),
	(115, 2, 3, 40, 27, 47, 20.00),
	(116, 2, 3, 41, 27, 47, 10.00),
	(117, 2, 3, 42, 27, 47, 10.00),
	(118, 2, 3, 43, 27, 47, 30.00);
...
INSERT INTO `trabajo_titulacion` (`id`, `carrera_id`, `modalidad_id`, `tutor_id`, `cotutor_id`, `estado_id`, `fecha_defensa`, `titulo`, `link_anteproyecto`, `link_final`, `suplente_id`, `indexacion_id`) VALUES
	(1, 4, 3, 58, 8, 1, NULL, 'Plataforma de Aprendizaje Virtual con Realidad Aumentada', 'http://www.drive.com/doc/id/439284729356325092346.pdf', '', NULL, NULL),
	...
	(3, 4, 1, 61, NULL, 4, '2025-07-28 20:55:00', 'Examen', 'https://docs.google.com/spreadsheets/d/1GE2VJ5yzEEagAQyGe3xM7S5F1U_YDX8P/edit?gid=141538943#gid=141538943', 'https://drive.google.com/drive/u/0/folders/1EYkDU2BK7zL6lS4j88Q-8_i1as5BN1ID', 61, NULL);
