...
-- Volcando datos para la tabla gestion_titulacion.rubrica: ~6 rows (aproximadamente)
...
INSERT INTO `trabajo_titulacion` (`id`, `carrera_id`, `modalidad_id`, `tutor_id`, `cotutor_id`, `estado_id`, `fecha_defensa`, `titulo`, `link_anteproyecto`, `link_final`) VALUES
	...
	(11, 4, 3, 2, NULL, 3, '2025-02-12 10:11:00', 'Desarrollo de una plataforma para enseñanza de la física universitaria desde dispositivo multisensorial', 'sdfghsdfgjsdfg', 'google.com'),
	...
	(19, 4, 2, 8, NULL, 3, '0000-00-00 00:00:00', 'Diseño de un esquema arquitectónico para integrar sistemas monolíticos con arquitecturas emergentes', '123456789', '');
...
-- Volcando datos para la tabla gestion_titulacion.usuario_rol: ~14 rows (aproximadamente)
