...
-- Volcando datos para la tabla gestion_titulacion.acta: ~2 rows (aproximadamente)
INSERT INTO `acta` (`id`, `year`, `num_year_count`, `trabajo_id`, `secretaria_id`, `vicedecano_id`, `asesor_juridico_id`, `fecha_hora`, `ciudad`, `lugar`) VALUES
	(6, 2025, 0, 20, 0, 61, 0, '2025-04-03 13:54:00', 'Portoviejo', 'la sala de sesiones del H. Consejo Directivo'),
	(7, 2025, 1, 19, 0, 61, 0, '2025-04-03 13:55:00', 'Portoviejo', 'la sala de sesiones del H. Consejo Directivo'),
	(8, 2025, 2, 10, 0, 61, 0, '2025-04-03 13:56:00', 'Portoviejo', 'la sala de sesiones del H. Consejo Directivo');
...
-- Volcando datos para la tabla gestion_titulacion.rubrica_evaluacion: ~121 rows (aproximadamente)
...
INSERT INTO `trabajo_titulacion` (`id`, `carrera_id`, `modalidad_id`, `tutor_id`, `cotutor_id`, `estado_id`, `fecha_defensa`, `titulo`, `link_anteproyecto`, `link_final`) VALUES
	...
	(20, 4, 1, 14, NULL, 4, '2025-04-08 10:07:00', 'Caso de estudio: App bibliotecaria', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view'),
	...
	(22, 4, 3, 8, NULL, 2, NULL, 'Sistema de control de parqueo subterráneo', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view'),
	(23, 4, 3, 8, NULL, 1, NULL, 'Sistema de control de riego autonomo', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', '');
