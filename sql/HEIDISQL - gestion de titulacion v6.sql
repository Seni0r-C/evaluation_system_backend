...
-- Volcando estructura para tabla gestion_titulacion.permisos_roles
...
-- Volcando datos para la tabla gestion_titulacion.rubrica_evaluacion: ~151 rows (aproximadamente)
INSERT INTO `rubrica_evaluacion` (`id`, `trabajo_id`, `rubrica_id`, `rubrica_criterio_id`, `docente_id`, `estudiante_id`, `puntaje_obtenido`) VALUES
	...
	(375, 19, 3, 39, 44, 47, 20.00),
	(376, 19, 3, 40, 44, 47, 20.00),
	(377, 19, 3, 41, 44, 47, 10.00),
	(378, 19, 3, 42, 44, 47, 10.00),
	(379, 19, 3, 43, 44, 47, 30.00),
	(380, 19, 4, 33, 44, 47, 32.00),
	(381, 19, 4, 34, 44, 47, 8.00),
	(382, 19, 4, 35, 44, 47, 8.00),
	(383, 19, 4, 36, 44, 47, 8.00),
	(384, 19, 4, 37, 44, 47, 8.00),
	(385, 19, 4, 38, 44, 47, 16.00),
	(386, 19, 3, 39, 43, 47, 20.00),
	(387, 19, 3, 40, 43, 47, 20.00),
	(388, 19, 3, 41, 43, 47, 10.00),
	(389, 19, 3, 42, 43, 47, 10.00),
	(390, 19, 3, 43, 43, 47, 30.00),
	(391, 19, 4, 33, 43, 47, 32.00),
	(392, 19, 4, 34, 43, 47, 8.00),
	(393, 19, 4, 35, 43, 47, 8.00),
	(394, 19, 4, 36, 43, 47, 8.00),
	(395, 19, 4, 37, 43, 47, 8.00),
	(396, 19, 4, 38, 43, 47, 16.00),
	(397, 19, 3, 39, 58, 47, 20.00),
	(398, 19, 3, 40, 58, 47, 20.00),
	(399, 19, 3, 41, 58, 47, 10.00),
	(400, 19, 3, 42, 58, 47, 10.00),
	(401, 19, 3, 43, 58, 47, 30.00),
	(402, 19, 4, 33, 58, 47, 32.00),
	(403, 19, 4, 34, 58, 47, 8.00),
	(404, 19, 4, 35, 58, 47, 8.00),
	(405, 19, 4, 36, 58, 47, 8.00),
	(406, 19, 4, 37, 58, 47, 8.00),
	(407, 19, 4, 38, 58, 47, 16.00),
	(408, 12, 1, 22, 43, 27, 40.00),
	(409, 12, 1, 23, 43, 27, 10.00),
	(410, 12, 1, 24, 43, 27, 10.00),
	(411, 12, 1, 25, 43, 27, 10.00),
	(412, 12, 1, 26, 43, 27, 10.00),
	(413, 12, 1, 27, 43, 27, 11.00),
	(414, 12, 2, 28, 43, 27, 30.00),
	(415, 12, 2, 29, 43, 27, 11.00),
	(416, 12, 2, 30, 43, 27, 10.00),
	(417, 12, 2, 31, 43, 27, 10.00),
	(418, 12, 2, 32, 43, 27, 11.00),
	(440, 20, 9, 44, 43, 47, 40.00),
	(441, 20, 9, 45, 43, 47, 10.00),
	(442, 20, 9, 46, 43, 47, 9.00),
	(443, 20, 9, 47, 43, 47, 10.00),
	(444, 20, 9, 48, 43, 47, 10.00),
	(445, 20, 9, 49, 43, 47, 20.00),
	(446, 20, 8, 50, 43, 47, 30.00),
	(447, 20, 8, 51, 43, 47, 20.00),
	(448, 20, 8, 52, 43, 47, 10.00),
	(449, 20, 8, 53, 43, 47, 10.00),
	(450, 20, 8, 54, 43, 47, 30.00),
	(451, 20, 7, 21, 58, 47, 30.00),
	(452, 20, 7, 21, 43, 47, 30.00),
	(453, 20, 7, 21, 44, 47, 30.00),
	(454, 20, 9, 44, 58, 47, 40.00),
	(455, 20, 9, 45, 58, 47, 10.00),
	(456, 20, 9, 46, 58, 47, 10.00),
	(457, 20, 9, 47, 58, 47, 10.00),
	(458, 20, 9, 48, 58, 47, 10.00),
	(459, 20, 9, 49, 58, 47, 20.00),
	(460, 20, 8, 50, 58, 47, 30.00),
	(461, 20, 8, 51, 58, 47, 20.00),
	(462, 20, 8, 52, 58, 47, 10.00),
	(463, 20, 8, 53, 58, 47, 10.00),
	(464, 20, 8, 54, 58, 47, 30.00),
	(465, 20, 9, 44, 44, 47, 30.00),
	(466, 20, 9, 45, 44, 47, 10.00),
	(467, 20, 9, 46, 44, 47, 10.00),
	(468, 20, 9, 47, 44, 47, 10.00),
	(469, 20, 9, 48, 44, 47, 10.00),
	(470, 20, 9, 49, 44, 47, 20.00),
	(471, 20, 8, 50, 44, 47, 15.00),
	(472, 20, 8, 51, 44, 47, 20.00),
	(473, 20, 8, 52, 44, 47, 10.00),
	(474, 20, 8, 53, 44, 47, 10.00),
	(475, 20, 8, 54, 44, 47, 30.00);
...
-- Volcando estructura para tabla gestion_titulacion.sistema_permisos
CREATE TABLE IF NOT EXISTS `sistema_permisos` (
  ...
  CONSTRAINT `sistema_permisos_ibfk_1` FOREIGN KEY (`permiso_id`) REFERENCES `sistema_permisos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla gestion_titulacion.sistema_permisos: ~0 rows (aproximadamente)
INSERT INTO `sistema_permisos` (`id`, `nombre`, `permiso`, `permiso_id`) VALUES
	(5, 'Ver panel admin', 'ver_panel_admin', NULL);
...
-- Volcando datos para la tabla gestion_titulacion.sistema_rol_ruta: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla gestion_titulacion.trabajo_estudiante: ~12 rows (aproximadamente)
INSERT INTO `trabajo_estudiante` (`id`, `trabajo_id`, `estudiante_id`, `intentos`, `resultado`) VALUES
	...
	(11, 22, 40, 0, 'Pendiente'),
	(12, 22, 48, 0, 'Pendiente'),
	(13, 23, 40, 0, 'Pendiente'),
	(14, 23, 48, 0, 'Pendiente');
...
-- Volcando datos para la tabla gestion_titulacion.trabajo_titulacion: ~10 rows (aproximadamente)
INSERT INTO `trabajo_titulacion` (`id`, `carrera_id`, `modalidad_id`, `tutor_id`, `cotutor_id`, `estado_id`, `fecha_defensa`, `titulo`, `link_anteproyecto`, `link_final`, `suplente_id`, `indexacion_id`) VALUES
	(10, 4, 3, 2, NULL, 4, '2025-03-07 07:50:00', '	Aplicación web para la medición del nivel de transformación digital para Instituciones de Educación Superior (IES)', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', '', NULL, NULL),
	(11, 4, 3, 2, NULL, 3, '2025-04-16 11:50:00', 'Desarrollo de una plataforma para enseñanza de la física universitaria desde dispositivo multisensorial', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', 'google.com', 8, NULL),
	(12, 4, 3, 14, 21, 3, '2025-04-22 09:24:00', 'Redes neuronales convulucionales para mejorar la resolución de imágenes medicas', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', '', 8, NULL),
	(13, 4, 3, 21, 14, 1, NULL, 'Word Embedding en documentos médicos através dela aplicación de Word2Vec y Doc2Vec', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', '', NULL, NULL),
	(18, 4, 3, 21, 21, 1, NULL, 'Aplicación de Técnicas de Aprendizaje Automático para predecir áreas en riesgo de incendio forestal', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', '', NULL, NULL),
	(19, 4, 2, 8, NULL, 4, '2025-03-05 08:16:00', 'Diseño de un esquema arquitectónico para integrar sistemas monolíticos con arquitecturas emergentes', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', '', NULL, 1),
	(20, 4, 1, 14, NULL, 4, '2025-04-08 10:07:00', 'Caso de estudio: App bibliotecaria', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', NULL, NULL),
	(21, 4, 3, 21, NULL, 2, NULL, 'Artificial intelligence (AI) applications for marketing: A literature-based study', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', NULL, NULL),
	(22, 4, 3, 8, NULL, 2, NULL, 'Sistema de control de parqueo subterráneo', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', NULL, NULL),
	(23, 4, 3, 8, NULL, 1, NULL, 'Sistema de control de riego autonomo', 'https://drive.google.com/file/d/17U6Pn-8IpUmS6pDc2VSR7T9Rm4tsNd7b/view', '', NULL, NULL);
